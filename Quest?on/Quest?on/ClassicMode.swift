...
class ClassicMode: SKScene {
    ...
    func createScene(){
        ...
        /* life */
        let life1 = SKSpriteNode(imageNamed: "icons8-heart")
        life1.name = "life1"
        life1.position = CGPoint(x: 40, y: 50)
        
        let life2 = SKSpriteNode(imageNamed: "icons8-heart")
        life2.name = "life2"
        life2.position = CGPoint(x: life1.position.x + life2.size.width , y: 50)
        
        let life3 = SKSpriteNode(imageNamed: "icons8-heart")
        life3.name = "life3"
        life3.position = CGPoint(x: life2.position.x + life3.size.width, y: 50)
    ...
    func checkUserAnswer(_ area: Int){
        ...
        if userAns == answer{
            ...
            print("INCORRECT.")
            result = false
            self.childNode(withName: "life"+String(life))?.removeFromParent()
            life -= 1
            if life == 0 {
                //game over
                print("game over.")
    ...
    func writeRecord(){
        ...
        let totalNumOfQuestion = record.object(forKey: "totalNumOfClassicQuestion") as! Int?
        if totalNumOfQuestion == nil{   // 累計答題數
            record.set(numOfQuestion, forKey: "totalNumOfClassicQuestion")
        }else{
            record.set(numOfQuestion + totalNumOfQuestion!, forKey: "totalNumOfClassicQuestion")
        }
        let totalNumOfAns = record.object(forKey: "totalNumOfClassicCorrectAns") as! Int?
        if totalNumOfAns == nil{    //  累計答對題數
            record.set(numOfCorrectAns, forKey: "totalNumOfClassicCorrectAns")
        }else{
            record.set(numOfCorrectAns + totalNumOfAns!, forKey: "totalNumOfClassicCorrectAns")
        }
        let largestNumOfClearedQuestion = record.object(forKey: "largestNumOfClassicClearedQuestion") as! Int?
        if largestNumOfClearedQuestion == nil { //  最長通關紀錄
            record.set(numOfCorrectAns, forKey: "largestNumOfClassicClearedQuestion")
            record.set(timeOfPlay, forKey: "timeOfClassicCleared")
        }else{
            if largestNumOfClearedQuestion! < numOfCorrectAns {
                ...
                let timeOfrecord = record.object(forKey: "timeOfClassicCleared") as! Int?
